...
<div id="comments">
	...
	<?php $isByAuthor = false; if($comment->comment_author_email == 'grav3Ruhe3et@jestro.com') { $isByAuthor = true; } ?>
		<div class="c-single clear <?php if($isByAuthor ) { echo 'admin';} ?> <?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>" >
			...
			<div class="c-body">
      <div class="c-date"><span><?php comment_date('Y'); ?></span> <?php comment_date('F j'); ?></div>
				<div class="c-head"><?php comment_author_link() ?></div>
				<?php comment_text() ?>
