...
$options = array(
        ...
        array(	"name" => __('Customize colors', 'vigilance'),
					    	...
					    	"std" => array(	"disabled" => __('Disabled', 'vigilance')),
					    	"type" => "select",
        ...
        array(	"name" => __('Disable hover images', 'vigilance'),
				...
				array(	"name" => __('Banner state', 'vigilance'),
			    			...
			    			"std" => array(	"rotate" => __('rotate', 'vigilance')),
			    			"type" => "select",
        ...
        array(	"name" => __('Alert Box On/Off', 'vigilance'),
			    			...
			    			"std" => array(	"off" => __('Off', 'vigilance')),
			    			"type" => "select",
        ...
        array(	"name" => __('Sidebar Image', 'vigilance'),
				...
				array(	"name" => __('Image state', 'vigilance'),
			    			...
			    			"std" => array(	"rotate" => __('Rotating images', 'vigilance')),
			    			"type" => "select",
			    			"options" => array(	"rotate" => __('Rotating images', 'vigilance'), 
																		"static" => __('Static image', 'vigilance'), 
																		"custom" => __('Custom code', 'vigilance'), 
        ...
        array(	"name" => __('Feed box state', 'vigilance'),
              	"desc" => __('Enable or disable the feed box in the sidebar.', 'vigilance'),
					    	...
					    	"std" => array( "enabled" => __('Enabled', 'vigilance')),
					    	"type" => "select",
					    	"options" => array(	"enabled" => __('Enabled', 'vigilance'), 
